...
class ExamePolicy
{
    ...
    {
        return $user->hasPermissionTo('View Exame');
    }
    ...
    {
        return $user->hasPermissionTo('Create Exame');
    }
    ...
    {
        return $user->hasPermissionTo('Edit Exame');
    }
    ...
    {
        return $user->hasPermissionTo('Delete Exame');
    }
